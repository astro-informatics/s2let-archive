function s2let_axisym_mw_wav_analysis_multires_real, f, B, J_min, verbose=verbose
;+
...
if s2let_dylib_exists() eq 1 then begin
   ...
   r = call_external(soname, 's2let_idl_axisym_mw_wav_analysis_multires_real', f_wav_vec, f_scal, double(f), B, L, J_min, /CDECL)
